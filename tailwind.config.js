...
const customPalettes = {
  // brand: generatePalette('#d25910')
  brand: generatePalette("#FF7C26"),
};

const customAccentPalettes = {
  brand: generatePalette("#353b4b"),
};
...
const themes = {
  ...
  brand: {
    ...
    accent: customAccentPalettes.brand,
  },
  teal: {
    primary: {
      ...colors.teal,
...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: `"Albert Sans", ${defaultTheme.fontFamily.sans.join(",")}`,
        mono: `"IBM Plex Mono", ${defaultTheme.fontFamily.mono.join(",")}`,
        altform: ["Altform_VF", "sans-serif"],
      },
      boxShadow: {
        "custom-red": "0 4px 6px rgba(42, 37, 37, 0.5)",
        'custom-card': '0px 1px 8px 0px #0000001A, 0px 1px 2px -1px #0000001A',
      },
      opacity: {
        12: "0.12",
        38: "0.38",
